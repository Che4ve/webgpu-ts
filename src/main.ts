...
import { projection, rotationAxisY, rotationAxisX, translation, multiply, normal } from "./math";
...
async function main() {
  ...
  for (const [a, b, c] of faces) {
    ...
    vertexData.push(a.x, a.y, a.z, n.x, n.y, n.z);
    vertexData.push(b.x, b.y, b.z, n.x, n.y, n.z);
    vertexData.push(c.x, c.y, c.z, n.x, n.y, n.z);
  }
